 ...
 * @access        private
 */
const add = (0, async_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // Validate product
    const file = req.file;
    if (!file) {
        res.status(404);
    ...
    const product = yield product_1.default.create(Object.assign(Object.assign({}, req.body), { price: JSON.parse(req.body.price), image: imageURL }));
    return res
        .status(201)
